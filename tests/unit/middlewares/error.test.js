...
describe('Error middlewares', () => {
  ...
  describe('Error handler', () => {
    ...
    test('should send proper error response and put the error message in res.locals', () => {
      ...
      expect(sendSpy).toHaveBeenCalledWith(expect.objectContaining({ code: error.statusCode, msg: error.message }));
    ...
    test('should put the error stack in the response if in development mode', () => {
      ...
      expect(sendSpy).toHaveBeenCalledWith(
        expect.objectContaining({ code: error.statusCode, msg: error.message, stack: error.stack })
      );
